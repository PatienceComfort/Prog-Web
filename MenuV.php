...
​		<textarea id="txtArea" rows="10" cols="60" name="query" placeholder = "Search.."> </textarea> <br><br>
	...
	<div id ="startAnnot">	
	<button id="close-image" name="img" onclick = "location.href = 'annotation.php'"> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/LambdaPhage_Genome_Linear.jpg/800px-LambdaPhage_Genome_Linear.jpg" height="100" width="145"><br> Annoter une Séquence </button> <br>
	</div >

	<div id ="startValid1">	
	<button id="close-image" name="img" onclick = "location.href = 'attribuer.php'"> <img src="https://icon-library.com/images/1333651-200.png" height="100" width="145"><br> Attribuer une Séquence </button> <br>
	</div >
	
	<div id ="startValid2">	
	<button id="close-image" name="img" onclick = "location.href = 'validation.php'"> <img src="https://www.datagenicgroup.com/wp-content/themes/blake-child/images/products/Blocks/qm-checks.png" height="100" width="145"><br> Valider une Séquence </button> <br>
	</div >
