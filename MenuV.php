...
<html lang="fr">
  ...
  <body>
	...
	Sequence ID :
​	<textarea id="txtArea" rows="1" cols="10" name="seqid" placeholder = "Search.."> </textarea> <br><br>
		
	Séquence : <br>
​	<textarea id="txtArea" rows="7" cols="60" name="query" placeholder = "Search.."> </textarea> <br><br>
...
​		<textarea id="txtArea" rows="10" cols="60" name="query" placeholder = "Search.."> </textarea> <br><br>
	...
	<div id ="startValid">	
	<button id="close-image" name="img" onclick = "location.href = 'PageRecherche.html'"> <img src="https://iqualidator.com/wp-content/uploads/2018/10/3.png" height="110" width="160"><br> Valider les Séquences </button> <br>
	</div>
